...
function M.setup(opts)
    ...
    vim.keymap.set({ "n", "t" }, "<leader>tt", function() manager.toggle_terminal() end, { desc = "Toggle last terminal" })
    ...
    vim.keymap.set({ "n", "t" }, "<leader>tnext", function() manager.next_terminal() end, { desc = "Next terminal" })
    vim.keymap.set({ "n", "t" }, "<leader>tprev", function() manager.prev_terminal() end, { desc = "Prev terminal" })

    -- Commands
    vim.api.nvim_create_user_command("FlotermNew", function() manager.new_terminal() end, {})
    vim.api.nvim_create_user_command("FlotermToggle", function(opts)
